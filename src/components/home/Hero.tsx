...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-industrial-dark via-[#0c2642] to-industrial-dark text-white overflow-hidden py-10 sm:py-16 lg:py-24 border-b border-slate-800 w-full max-w-full">
      ...
      <div className="industrial-container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          {/* Left Column: Typography, CTAs & Technical Value Points (7 cols) */}
          <div className="lg:col-span-7 space-y-4 sm:space-y-6">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 sm:px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20 text-xs font-semibold tracking-wider uppercase text-industrial-highlight backdrop-blur-md"
            >
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold font-heading tracking-tight text-white leading-[1.14]">
              <PrecisionText
            ...
            <motion.p
              ...
              className="text-xs sm:text-base lg:text-lg text-slate-300 leading-relaxed max-w-2xl font-normal"
            >
            ...
            {/* Primary & Secondary CTAs - Above the fold on Mobile */}
            <motion.div
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link
                to="/solutions"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-7 py-3 sm:py-3.5 rounded-lg bg-industrial-primary text-white font-bold text-xs sm:text-sm tracking-wide transition-all duration-200 hover:bg-sky-500 shadow-lg shadow-blue-900/30 hover:scale-[1.01] active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-sky-400 group text-center"
              >
              ...
              <button
                type="button"
                onClick={() => openEnquiry()}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-7 py-3 sm:py-3.5 rounded-lg bg-white/10 text-white font-semibold text-xs sm:text-sm border border-white/20 backdrop-blur-sm transition-all duration-200 hover:bg-white/20 hover:scale-[1.01] active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-sky-400 text-center"
              >
            ...
            {/* Sleek Capability Badges - Compact Inline Strip */}
            <motion.div
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.45, ease: [0.16, 1, 0.3, 1] }}
              className="flex flex-wrap items-center gap-2 pt-1 text-xs text-slate-300"
            >
              <div className="inline-flex items-center gap-1.5 bg-white/5 border border-white/10 rounded-full px-3 py-1.5 transition-colors hover:bg-white/10">
                <CheckCircle2 className="w-3.5 h-3.5 text-sky-400 shrink-0" />
                <span className="font-medium text-[11px] sm:text-xs">Automated Multi-Gauging</span>
              </div>
              <div className="inline-flex items-center gap-1.5 bg-white/5 border border-white/10 rounded-full px-3 py-1.5 transition-colors hover:bg-white/10">
                <CheckCircle2 className="w-3.5 h-3.5 text-sky-400 shrink-0" />
                <span className="font-medium text-[11px] sm:text-xs">Compressed Air Technology</span>
              </div>
              <div className="inline-flex items-center gap-1.5 bg-white/5 border border-white/10 rounded-full px-3 py-1.5 transition-colors hover:bg-white/10">
                <CheckCircle2 className="w-3.5 h-3.5 text-sky-400 shrink-0" />
                <span className="font-medium text-[11px] sm:text-xs">Tailored Fixtures</span>
              </div>
            </motion.div>

            {/* Micro Metrology Indicator Strip */}
            <div className="pt-3 border-t border-slate-800/80 flex flex-wrap items-center gap-x-5 gap-y-2 text-[11px] sm:text-xs text-slate-400">
          ...
          {/* Right Column: Hero High-Res Metrology Image with Click to View (5 cols) */}
          <motion.div
          ...
          >
            <div 
              ...
              className="relative rounded-2xl overflow-hidden border-2 border-slate-700/80 shadow-2xl bg-industrial-dark group cursor-pointer"
            ...
            >
              ...
              <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 p-3 sm:p-3.5 rounded-xl bg-industrial-dark/85 backdrop-blur-md border border-slate-700 text-xs text-slate-200 flex items-center justify-between">
                <div>
