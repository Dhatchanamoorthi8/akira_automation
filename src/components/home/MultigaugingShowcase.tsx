...
export const MultigaugingShowcase: React.FC = () => {
  ...
  return (
    <SectionReveal className="py-20 bg-industrial-dark text-white relative overflow-hidden">
      ...
      <div className="industrial-container relative z-10">
        ...
        <div className="flex border-b border-slate-700 mb-8 gap-2">
          <button
