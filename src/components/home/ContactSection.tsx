    ...
    <SectionReveal id="contact-section" className={`py-12 sm:py-16 lg:py-20 ${isStandalone ? 'bg-white' : 'bg-industrial-bg'} border-b border-slate-200 overflow-hidden`}>
      <div className="industrial-container">
        ...
        <Reveal direction="up" className="max-w-3xl mb-8 sm:mb-12">
          ...
          <p className="mt-3 text-base sm:text-lg text-slate-700 leading-relaxed font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <Reveal direction="right" className="lg:col-span-5 space-y-6">
            <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-card space-y-6">
              ...
              <div className="border-b border-slate-100 pb-4">
                <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-industrial-primary">
          ...
          <Reveal direction="left" delay={0.15} className="lg:col-span-7">
            <div className="bg-white p-6 sm:p-10 rounded-2xl border border-slate-200 shadow-card">
              <div className="mb-6">
                <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-industrial-primary">
