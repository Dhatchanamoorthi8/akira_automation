    ...
    >
      ...
      <div className="p-5 sm:p-6 pt-0 border-t border-slate-100 flex items-center justify-between gap-3 mt-4">
        ...
        <button
          ...
          className="px-4 py-2 min-h-[40px] rounded-lg bg-slate-100 hover:bg-industrial-primary hover:text-white text-xs font-semibold text-industrial-dark transition-colors active:scale-95 border border-slate-200/80"
        >
          Enquire Now
        </button>
      </div>
