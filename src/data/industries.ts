...
export const industries: Industry[] = [
  {
    ...
    description: "AKIRA AUTOMATION supports automotive original equipment manufacturers with high-precision automated multi-gauging stations, cylinder liner bore inspection systems, and camshaft inspection fixtures tailored to stringent vehicle manufacturing standards.",
    ...
    gaugingRelevance: "Automotive OEMs demand 100% inspection reliability and zero tolerance for defect escapes. AKIRA AUTOMATION's automated multi-gauging stations provide rapid, repeatable, and traceable measurement directly on the production floor."
  },
  {
    id: "tier-1-suppliers",
  ...
  },
  {
    ...
    description: "AKIRA AUTOMATION empowers Tier-2 machining, turning, and stamping facilities with rugged, cost-effective air plug gauges, air ring gauges, attribute gauges, and standard measuring instruments that ensure full compliance with Tier-1 drawing specifications.",
  ...
  },
  {
    ...
    description: "AKIRA AUTOMATION works closely with automation integrators and special purpose machine (SPM) builders to supply automation-ready gauging probes, multi-channel display units, and pneumatic air servers that interface directly with PLC automation lines.",
  ...
  },
  {
    ...
    description: "Across aerospace, hydraulics, defense, valve manufacturing, and heavy engineering, AKIRA AUTOMATION provides custom-built special fixtures, air gauge display units, and standards calibration equipment that maintain micron-level accuracy.",
